...
export function ConditionModal({
  ...
  return (
    ...
    >
      <div className="bg-[var(--color-bg-surface)] rounded-2xl w-full max-w-md max-h-[calc(100vh-160px)] overflow-hidden shadow-2xl">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-4 overflow-y-auto max-h-[calc(100vh-340px)]">
          {/* 重要性の説明 */}
