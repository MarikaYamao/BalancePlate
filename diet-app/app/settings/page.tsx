...
import {
  ...
  type GoalType,
  type GoalPeriod,
} from "@/components/features/settings/GoalSettingsModal";
...
export default function SettingsPage() {
  ...
  const [activeSection, setActiveSection] = useState<"profile" | "backup">(
    "profile",
  );
    ...
    try {
      ...
      if (settings) {
        ...
        if (settings.profile) {
          ...
          setGoalPeriod(
            (settings.profile.goalPeriod as GoalPeriod) || "no_limit",
          );
        }
  ...
  const calculateProfileCompleteness = () => {
    ...
    const checks = {
      ...
      goal: !!goalType, // 目標設定
      bodyInfo:
        bodyConstitution.includes("healthy") || bodyConstitution.length > 0,
  ...
  const getIncompleteItems = () => {
    ...
    // 健康体の場合も選択を促す
    if (
      !bodyConstitution.includes("healthy") &&
      bodyConstitution.length === 0
    ) {
    ...
    <MainLayout>
      <div className="min-h-screen pb-24">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-4 pb-8">
          ...
          <div className="mt-4 bg-white/20 backdrop-blur rounded-lg p-3">
            ...
            {calculateProfileCompleteness() < 100 ? (
              <div className="mt-2">
                <p className="text-xs opacity-90 mb-1">未入力項目：</p>
        ...
        {mounted &&
          ...
          createPortal(
            <div
              className="fixed bottom-16 left-0 right-0 p-4 bg-gradient-to-t from-white via-white to-transparent z-[100]"
            ...
            >
              ...
              {message && (
                <p
                  className={`mt-2 text-sm text-center font-medium animate-fade-in ${
